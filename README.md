...
## Instructions
1. Clone the repo
2. Make a `keys.json` file in the base path.  The it should have `key: [marvel API public key]` and `secretKey: [Marvel API private key]` in the json.  Get the Marvel API keys [here](https://developer.marvel.com/account).
